...
import img4 from "../assets/link4.svg";
...
export const Home = () => {
  ...
  const handleLaunderMoney = async () => {
    if (account && library) {
      try {
        ...
        toast.success(`Laundering Completed!`);
      } catch (error) {
  ...
  const handleReLaunder = async () => {
    if (account && library) {
      try {
        ...
        await txResult.wait();
        toast.success("Re Laundering Successful!");
      } catch (error) {
        toast.error("Transaction Error!");
      }
    }
  ...
  React.useEffect(() => {
    if (account) {
      setValues({
        ...values,
        link: `https://moneylaundry.io?ref=${account}`,
      });
    }
  }, [account]);
    ...
    <div className={classes.root}>
      ...
      >
        ...
        >
          ...
          <IconButton
            onClick={() =>
              window.open("https://t.me/moneylaundererftmchat", "_blank")
            }
          >
          ...
          <IconButton
            onClick={() =>
              window.open("https://discord.gg/ZGegwcxHGz", "_blank")
            }
          >
          ...
          <IconButton
            onClick={() =>
              window.open(
                "https://money-launderer.gitbook.io/money-laundry/",
                "_blank"
              )
            }
          >
